...
test("studio inspiration uses tutorial video, a saved link, or text—not finished photos",()=>{const page=fs.readFileSync("app/page.tsx","utf8");assert.match(page,/Upload a tutorial/);assert.match(page,/Paste a tutorial link/);assert.match(page,/Describe your idea/);assert.equal(page.includes("Upload a reference"),false)});
