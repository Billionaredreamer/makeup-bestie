...
export async function POST(request: Request) {
  ...
  try {
    ...
    console.error("Billing portal creation failed:", error instanceof Error ? error.message : "Unknown billing error");
    return NextResponse.json({ error: "Subscription management is temporarily unavailable. Please try again shortly." }, { status: 502 });
  }
}
