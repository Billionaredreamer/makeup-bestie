...
export default function TermsPage() {
  return <main className="legal-page">
    ...
    <section><h2>Service</h2><p>Makeup Bestie turns eligible makeup tutorials into personalized educational placement guidance. Face-shape and product suggestions are estimates. The service is not medical, dermatological, or professional health advice; stop using a product if irritation or another safety concern occurs.</p></section>
