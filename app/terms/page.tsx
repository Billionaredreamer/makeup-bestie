...
export default function TermsPage() {
  return <main className="legal-page">
    ...
    <section><h2>Subscriptions</h2><p>Plus is $12.99 per month and includes 15 tutorial adaptations per calendar month. Unlimited is $49.99 per month for normal personal use and includes reasonable anti-automation and abuse protection. Plans renew until cancelled. Where you bought the plan determines how you manage it: subscriptions purchased in the iOS app are billed through your Apple ID and are managed or cancelled in your Apple ID subscription settings, while subscriptions purchased on this website are billed through Stripe and are managed in the Stripe billing portal. An Apple subscription renews automatically unless auto-renew is turned off at least 24 hours before the end of the current period, and your Apple ID is charged for renewal within 24 hours prior to the end of that period. Cancellation takes effect at the end of the paid period unless applicable law requires otherwise. Refunds for App Store purchases are handled by Apple.</p></section>
